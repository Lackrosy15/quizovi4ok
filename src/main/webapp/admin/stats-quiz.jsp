...
<main class="main-content">
    <div class="header">
        <h1 class="page-title">Статистика квиза</h1>
    </div>

    <div class="content-wrapper">
        <div class="quiz-list">
            <div class="quiz-list-header">
                <h2 class="section-title"><c:out value="${passingQuizzesByQuizId[0].quizName}"/> </h2>
            </div>
            <c:forEach var="passingTheQuiz" items="${passingQuizzesByQuizId}">
                <div class="quiz-item">
                    ...
                    <div class="quiz-actions">
                        <a href="/admin/stat/${passingTheQuiz.passId}" class="form-link">
                            <span>Подробнее</span>
